...
class ConsumptionForm(forms.ModelForm):
    class Meta:
        model = Consumption
        fields = ['name', 'info', 'cost', 'sub_category', 'time', 'status', 'types_camunalca']
    ...
    types_camunalca = forms.ChoiceField(choices=Consumption.TYPES_CAMUNALCA, widget=forms.Select(attrs={'class': 'form-control'}))